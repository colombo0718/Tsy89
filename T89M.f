C	The file T89M.FOR  22-May-1993
C
          SUBROUTINE  T89M (ID, A, XI, F, DER)
C
C        ***  N.A. Tsyganenko ***  8-10.12.1991  ***
C        ***     (REVISED APRIL 1992)            ***
C
...
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
C
C      T89M represents external magnetospheric magnetic field
...
C
C      Model formulae for the magnetic field components contain in total
...
c   due to DivB=0 condition, are expressed thru A(6)-A(15) and hence are not
c    independent ones.
c  A(16) AND A(17) CORRESPOND TO THE TERMS WHICH YIELD THE TILT ANGLE DEPEN-
C    DENCE OF THE TAIL CURRENT INTENSITY (ADDED ON APRIL 9, 1992; SEE COMMENTS
C   IN THE BROWN GODDARD NOTEBOOK)
C
...
C
C   The last two quantities define variation of tail sheet thickness along X
C
