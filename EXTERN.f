C==== EXTERN.f ==================================================
C
      SUBROUTINE EXTERN(IOPT,PS,X,Y,Z,BX,BY,BZ)
C
C  CALCULATES GSM COMPONENTS OF THE EXTERNAL MAGNETIC FIELD BY CALLING
C  THE SUBROUTINE T89M; IF EXTERN IS CALLED FOR THE FIRST TIME OR IF
C   THE VALUE OF IOPT (DEFINING KP-INDEX LEVEL) HAS BEEN CHANGED, A NEW
C    SET OF MODEL PARAMETERS IS READ FROM THE ARRAY PARAM
C
       DIMENSION XI(4),F(3),DER(3,30),PARAM(30,7)
       COMMON /PAR/ A(30)
